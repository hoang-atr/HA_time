function [X, I, L] = feature_extraction_linear(data, spk_model, thr_svm, Nrefrac, Npre, Nwin)
...
ref_sig = l_score;
svm_threshold = mean(ref_sig)+std(ref_sig)*thr_svm;
...
[X, I, L] = do_sampling(data, l_score, select_idx, Npre, Nwin);    
